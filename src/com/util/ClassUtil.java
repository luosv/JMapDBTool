...
//                                        	Class<?> forName = Class.forName(packageName + '.' + className);
    ...
    public static <T> void findAndAddClassesInPackageByFile(String packageName,
                                                            String packagePath, final boolean recursive, Set<Class<T>> classes, Class<T> parentClass) {
        // 获取此包的目录 建立一个File  
...
//    	Class baseCls=BaseLogBean.class;
        Set<Class<BaseLogBean>> classes = getSubClasses("game.core", BaseLogBean.class);

        for (Class<BaseLogBean> cls : classes) {
            BaseLogBean newInstance;
            try {
                System.out.print(cls);
                newInstance = cls.newInstance();
                System.out.println(" " + newInstance.getRollingStep());
